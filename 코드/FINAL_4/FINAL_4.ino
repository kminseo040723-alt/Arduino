...
const int R_PWM[] = { 3, 6, 11 };
const int L_PWM[] = { 5, 9, 10 };
...
// Gripper open/close
const unsigned long Steps_Per_Revolution_Open = 20000;
...
const int Climb_Intermediary_Speed = 160;
...
const unsigned long Climb_Start_Time_Delay = 2000;
